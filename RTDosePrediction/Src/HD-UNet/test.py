...
def test_time_augmentation(trainer, input_, TTA_mode):
    ...
    for list_flip_axes in TTA_mode:
        ...
        prediction = flip_3d(np.array(prediction.cpu().data[0, :, :, :, :]), list_flip_axes)

        list_prediction_B.append(prediction[0, :, :, :])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='../../Output/HD-U-Net/best_val_evaluation_index.pkl')
