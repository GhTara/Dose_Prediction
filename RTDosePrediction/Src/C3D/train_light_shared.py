...
class CascadeUNet(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        # optimizer = bnb.optim.Adam8bit(self.model_.parameters(), lr=0.001) # instead of torch.optim.Adam
...
def main():
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath=config.CHECKPOINT_MODEL_DIR_DOSE_SHARED_SIMPLE,
    ...
    mlflow_logger = MLFlowLogger(
        ...
        # run_id = 'eb102adc78864c77b09ddd37548f6a44',
        # run_name = 'shared_model_simple',
        run_id = '4da652983b9b410ba76f4d86693f1474'
    )
    ...
    trainer = pl.Trainer(
        ...
        # callbacks=[bar],
        default_root_dir=config.CHECKPOINT_MODEL_DIR_DOSE_SHARED_SIMPLE,
        # enable_progress_bar=True,
        # log_every_n_steps=net.check_val,
    )

    # train
    # trainer.fit(net, datamodule=openkbp, ckpt_path='/content/drive/MyDrive/results_thesis/simple_dose_shared/last.ckpt')
