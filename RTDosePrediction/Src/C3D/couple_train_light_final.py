...
class CoupleNet(pl.LightningModule):
    def __init__(
        ...
        #     self.dose_model.freeze()
        #     self.seg_model.freeze()
    ...
    def test_step(self, batch_data, batch_idx):
        ...
        # # ------------- to calculate metrics related to OARs predictor --------------
        # oars = [config_seg.post_pred(i) for i in decollate_batch(oars)]
        # gt1 = [config_seg.post_label(i) for i in decollate_batch(gt1)][0]
        
        # gt1 = [torch.permute(gt1, (0, 3, 2, 1))]
        
        # dice_metric = self.dice_metric_test(y_pred=oars, y=gt1)
        ...
        # hd95_metric = self.hd95_metric_test(y_pred=oars, y=gt1)
        ...
        # print(ct.shape, oars.shape, ptv.shape)
        ...
        ckp_re_dir = '/content/drive/MyDrive/results_thesis_images/linked'
        if batch_idx<100:
        ...
        # # pred_img = torch.permute(prediction[0], (1,0,2,3))
...
def main(freez=True):
    ...
    mlflow_logger = MLFlowLogger(
        experiment_name='/Users/gheshlaghitara@gmail.com/dose_prediction_total',
    ...
    # train
    # trainer.fit(net, datamodule=openkbp, ckpt_path='/content/drive/MyDrive/results_thesis/final_couple/last.ckpt')
